...
.btn-info:hover {
  background: #057F73 !important;
}

.figure {
    margin: 1em 2.5em 1em 2.5em !important;
}
</style>
...
<button class="accordion-button collapsed btn btn-info" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
        Gráficos descriptivos de cada una de las variables financieras 
</button>
</h5>
...
<a onclick="porqueLog()">**(¿Por qué realizar la transformación de logaritmo natural?)**
</a>
...
<a onclick="porqueEsc()">**¿Por qué escalar las variables para realizar las agrupaciones?**</a>
...
<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExampl">
<div class="accordion-body">
...
<button class="accordion-button collapsed btn btn-info" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
        Gráficos que permitirán sacar caraterísticas de cada uno de los grupos
</button>
</h5>
<div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExamp">
<div class="accordion-body">
...
De la gráfica anterior se muestra los grupos obtenidos con la segmentación en las variables financieras, gráficada solo en las variables financieras. Su análisis se puede observar en el procedimiento 2 <a onclick="conclusiones2()">conclusiones</a>
...
* https://github.com/salitomeyo/TAE2 
...
<script>
function porqueLog(){
  document.getElementById("introducción").style.display= "none"
  document.getElementById("análisis-descriptivo").className =     "section level1 well page active"
  document.getElementById("análisis-descriptivo").style.display=   "block"
  document.getElementsByClassName("withripple")[2].className = "withripple"
  document.getElementsByClassName("withripple")[1].className = "withripple active"
  location.href = '#porque-logaritmo';
}
function porqueEsc(){
  document.getElementById("introducción").style.display= "none"
  document.getElementById("análisis-descriptivo").className =     "section level1 well page active"
  ...
  document.getElementsByClassName("withripple")[2].className = "withripple"
  document.getElementsByClassName("withripple")[1].className = "withripple active"
  location.href = '#porque-escalar';
}
function conclusiones2(){
  document.getElementById("procedimiento-de-segmentación-3").style.display= "none"
  document.getElementById("procedimiento-de-segmentación-2").className =     "section level1 well page active"
  document.getElementById("procedimiento-de-segmentación-2").style.display=   "block"
  document.getElementsByClassName("withripple")[5].className = "withripple"
  document.getElementsByClassName("withripple")[4].className = "withripple active"
  location.href = '#conclusiones-prod2';
}
</script>
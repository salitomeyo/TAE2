...
boxplot(log(df[,1:11]+1), las=2, col="cyan4", main = "montos de entrada anual", cex.main=0.8)
grid()
boxplot(log(df[,12:22]+1), las=2, col="cyan4", main = "transacciones de entrada mensual", cex.main=0.8)
grid()
```
...
realmente se pasó por muchas etapas, en este documento se presentan las que generaron mejores resultados e hicieron que los grupos tuvieran mayor sentido, además de ello se verificó que todos los procesos fueran estadísticamente válidos.

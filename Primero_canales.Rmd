...
set.seed(23)
Agru_canal <- kmeans(Canal_scaled[-c(825, 1416, 1462, 1668, 1773),], 2 , nstart = 5, iter.max = 100)

clusplot(Canal_scaled[-c(825, 1416, 1462, 1668, 1773),], Agru_canal$cluster, color = TRUE, 

...
```{r}
plot(1:15, colMeans(Canal_no_scaled), type = 'b', col = '#038EC3', 
...
Del gráfico anterior se observa que:
 ...
 - El canal 2 tiene un mayor ingreso de dinero, pero a la misma vez es el que tiene menor salida de dinero, por lo que se puede intuir que es un canal de pagos.
